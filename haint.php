...
function getd()
{
  ...
  xmlHttp.open("GET", "ajax4.php?s="+s+"&d="+d, true);
  xmlHttp.send();
}
</script>
</head>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php include 'm1.php'; ?>
	   ...
	   <div  class="card-body">
	   <form name="f" class="was-validated" action="hinta.php" method="post">
	    <div class="row">
                    <div class="col-sm-6">
                      <!-- select -->
	   ...
	   <div class="col-sm-6">
	   <div  class="form-group">
	   <select class="select2-blue form-control" id="x1" name="sub" required onChange="getd()">
	   ...
	   <table class="table table-striped" id="x2">
