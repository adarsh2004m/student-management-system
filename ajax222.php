...
?> <input type="text" name="te" value="<?php echo $r3['temail']; ?>" style="display:none"><tr><th>Name</th><th>Photo</th><th>Progress</th><th style="width:45px">Percentage</th></tr><?php
...
<?php }
?> <tr> <div align="right"><label>Signed by</label><p><?php  echo $r3['temail'];?></p></div><button value="approve" name="approve" class="btn btn-success" type="submit">Approve</button></tr><?php
}else
{ echo "no data";}
?>