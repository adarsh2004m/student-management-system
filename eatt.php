...
function getlist(s)
{
  ...
  xmlHttp.open("GET", "ajax6.php?s="+s+"&d="+d, true);
  xmlHttp.send();
}
</script>
</head>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php include 'm1.php'; ?>
	   ...
	   <div  class="card-body">
	   <form name="f" class="was-validated" action="atte.php" method="post">
	   <input type="text" value="<?php echo $x; ?>" name="d" style="display:none">
	   <select class="select2-blue form-control" required onChange="getlist(this.value)">
	   ...
	   <table class="table table-striped" id="x1">
