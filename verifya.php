...
function getlist(s)
{
  ...
  xmlHttp.open("GET", "ajax222.php?s="+s+"&d="+d, true);
  xmlHttp.send();
}
</script>
</head>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php include 'm1.php'; ?>
	   ...
	   <div  class="card-body">
	   <form name="f" class="was-validated" action="averify.php" method="post" >
	   <input type="text" value="<?php echo $x; ?>" name="d" style="display:none">
	   <select class="select2-blue form-control" required onChange="getlist(this.value)" name="ss1">
